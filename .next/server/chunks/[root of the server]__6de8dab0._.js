...
"[project]/.next-internal/server/app/api/models/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET(request) {
    try {
        ...
        if (brandId) {
            ...
            models = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].model.findMany({
                where: {
                    brandId: brandId
                },
                include: {
...
async function POST(request) {
    try {
        ...
        const existingModel = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].model.findFirst({
            where: {
                name,
                brandId
            }
        ...
        // Yeni model oluştur
        const model = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].model.create({
            data: {
                name,
                brandId
            },
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(model, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6de8dab0._.js.map