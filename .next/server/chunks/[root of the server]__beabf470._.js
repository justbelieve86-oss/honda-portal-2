...
async function GET(request) {
    try {
        ...
        if (user.role === 'SATIS_MUDURU') {
            ...
            try {
                ...
                if (userBrandIds.length > 0) {
                    ...
                    const samebrandUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].userBrand.findMany({
                        where: {
                            brandId: {
                                in: userBrandIds
                            }
        ...
        const sales = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sale.findMany({
            where: {
                createdBy: {
        ...
        const corporateSales = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].corporateSale.findMany({
            where: {
                createdBy: {
                    in: authorizedUserIds
                },
...
async function POST(request) {
    try {
        ...
        if (customerType === 'individual') {
            ...
            const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].customer.findFirst({
                where: {
                    id: customerId,
                    createdBy: userId
                }
            ...
            newSale = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sale.create({
                data: {
                    customerId,
                    model,
                    chassisNo,
            ...
            const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].corporateCustomer.findFirst({
                where: {
                    id: customerId,
                    createdBy: userId
                }
            ...
            newSale = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].corporateSale.create({
                data: {
                    customerId,
                    model,
                    chassisNo,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__beabf470._.js.map