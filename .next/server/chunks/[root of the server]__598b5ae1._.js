...
"[project]/.next-internal/server/app/api/brands/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET(request) {
    try {
        ...
        const allBrands = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].brand.findMany({
            include: {
                models: {
                    include: {
                        packages: true
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(allBrands);
    } catch (error) {
...
async function POST(request) {
    ...
    try {
        ...
        const existingBrand = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].brand.findUnique({
            where: {
                name
            }
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Marka oluşturulurken bir sunucu hatası oluştu',
            details: error.message,
            code: error.code
        }, {
            status: 500
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__598b5ae1._.js.map