...
async function GET(request) {
    try {
        ...
        const corporateCustomers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].corporateCustomer.findMany({
            where: whereClause,
            include: {
                sales: true,
                createdByUser: {
...
async function POST(request) {
    try {
        ...
        const existingCorporateCustomer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].corporateCustomer.findUnique({
            where: {
                taxNumber: data.taxNumber
            }
        });
        ...
        const newCorporateCustomer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].corporateCustomer.create({
            data: {
                name: data.name,
                taxNumber: data.taxNumber,
                taxOffice: data.taxOffice,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__bf3e51c9._.js.map