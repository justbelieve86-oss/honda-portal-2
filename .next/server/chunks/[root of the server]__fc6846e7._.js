...
async function GET(request) {
    try {
        ...
        const usersWithBrands = await Promise.all(users.map(async (user)=>{
            try {
                const userBrands = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].userBrand.findMany({
                    where: {
                        userId: user.id
                    },
                    include: {
                ...
                return {
                    ...user,
                    authorizedBrands: userBrands.map((ub)=>ub.brand)
                };
            } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(usersWithBrands);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
            where: {
                OR: [
                    {
        ...
        if (data.authorizedBrandIds && data.authorizedBrandIds.length > 0) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].userBrand.createMany({
                    data: data.authorizedBrandIds.map((brandId)=>({
                            userId: newUser.id,
                            brandId: brandId
                        }))
                });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(formattedUser, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fc6846e7._.js.map