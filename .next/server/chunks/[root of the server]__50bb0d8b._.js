...
async function GET(request) {
    try {
        ...
        const usersWithBrands = await Promise.all(users.map(async (user)=>{
            try {
                const userBrands = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].userBrand.findMany({
                    where: {
                        userId: user.id
                    },
                    include: {
...
async function POST(request) {
    try {
        ...
        if (data.authorizedBrandIds && data.authorizedBrandIds.length > 0) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].userBrand.createMany({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__50bb0d8b._.js.map